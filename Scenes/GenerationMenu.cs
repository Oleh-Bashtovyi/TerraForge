...
public partial class GenerationMenu : CanvasLayer
{
    ...
    // ENABLES:
    // RegenerateOnParametersChanged
    // DomainWarping
    // Islands
    // (CURRENTLY NOT) WaterDisplay
    // (CURRENTLY NOT) SlopesDisplay


    // CURRENT:
    // CurGenerator          GeneratorOptions
    // CurDisplayFormat      Grey/Color/Gradient/(CURRENTLY NOT)Normals
    // CurDisplayMap         [,]
    // CurSlopesMap          [,]
    // CurTreesMap           [,]
    // CurSmoothCycles       [0; 10]
    // CurWaterLevel         [0.0; 1.0]
    // CurSlopeThreshold     [0.0; 1.0]
    // CurMapRiseLowerValue  [0.01; 0.3]
